...
const (
	...
	gatewayAttributeDescription = "Next hop IPv6 address for this route."
	...
	targetAttributeDescription = "Destination IPv6 network in CIDR notation (e.g. \"2001:db8::/32\")."
	targetUCIOption            = "target"

	schemaDescription = "Manages a static IPv6 route."
