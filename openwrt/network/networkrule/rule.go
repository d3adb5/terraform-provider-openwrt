...
const (
	...
	destAttribute            = "dest"
	destAttributeDescription = "Destination subnet to match in CIDR notation (e.g. \"192.168.2.0/24\")."
	destUCIOption            = "dest"
	...
	srcAttribute            = "src"
	srcAttributeDescription = "Source subnet to match in CIDR notation (e.g. \"192.168.1.0/24\")."
	srcUCIOption            = "src"
	...
	schemaDescription = "Manages an IPv4 policy routing rule. Rules select which routing table to use based on packet attributes."
