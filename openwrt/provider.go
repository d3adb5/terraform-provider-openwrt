...
import (
	...
	acmecert "github.com/ORFops/terraform-provider-openwrt/openwrt/acme/cert"
	acmesettings "github.com/ORFops/terraform-provider-openwrt/openwrt/acme/settings"
	ddnsservice "github.com/ORFops/terraform-provider-openwrt/openwrt/ddns/service"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/dhcp/dhcp"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/dhcp/dnsmasq"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/dhcp/domain"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/dhcp/host"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/dhcp/odhcpd"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/firewall/defaults"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/firewall/forwarding"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/firewall/redirect"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/firewall/rule"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/firewall/zone"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/internal/lucirpcglue"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/bridgevlan"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/device"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/globals"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/networkinterface"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/networkroute"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/networkroute6"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/networkrule"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/networkrule6"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/networkswitch"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/network/switchvlan"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/system/system"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/system/timeserver"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/wireless/wifidevice"
	"github.com/ORFops/terraform-provider-openwrt/openwrt/wireless/wifiiface"
)
